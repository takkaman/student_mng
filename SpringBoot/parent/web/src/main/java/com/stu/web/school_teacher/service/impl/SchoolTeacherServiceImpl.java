package com.stu.web.school_teacher.service.impl;
...
import com.stu.web.school_teacher.mapper.SchoolTeacherMapper;
...
public class SchoolTeacherServiceImpl extends ServiceImpl<SchoolTeacherMapper, SchoolTeacher> implements SchoolTeacherService {
    ...
    public TeacherStatsVo getTeacherStats(Long teacherId) {
        return this.baseMapper.getTeacherStats(teacherId);
    }

    @Override
    public Long getAccCourseDuration(Long teacherId) {
        return this.baseMapper.getAccCourseDuration(teacherId);
    }
}
