<template>
  <el-main>
    ...
    <el-form :model="searchModel" :inline="true" size="small">
      ...
      <el-form-item>
        ...
        <el-button style="color:#FF7670;" icon="el-icon-close" @click="resetBtn"
          >重置</el-button
        >
        <el-button v-permission="['sys:teacherList:add']" icon="el-icon-plus" type="primary" @click="addBtn"
          >新增</el-button
        >
      </el-form-item>
    </el-form>
    ...
    <el-table :height="tableHeight" :data="tableList" border stripe>
      ...
      <el-table-column prop="teacherNum" label="编号"></el-table-column>
      <el-table-column prop="sex" label="性别">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.sex == '0'" type="danger" size="small"
            >男</el-tag
          >
          <el-tag v-if="scope.row.sex == '1'" type="success" size="small"
            >女</el-tag
          >
        </template>
      </el-table-column>
      <el-table-column label="操作" align="center" width="320">
        <template slot-scope="scope">
          <el-button
            v-permission="['sys:teacherList:edit']"
            type="primary"
            icon="el-icon-edit"
            size="small"
          ...
          >
          <el-button
            v-permission="['sys:teacherList:reset']"
            icon="el-icon-delete"
            type="warning"
            size="small"
          ...
          >
          <el-button
            v-permission="['sys:teacherList:delete']"
            type="danger"
            icon="el-icon-delete"
            size="small"
          ...
          <el-row>
            <el-col :span="12" :offset="0">
              <el-form-item prop="teacherName" label="姓名">
                <el-input v-model="addModel.teacherName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12" :offset="0">
          ...
          <el-row>
            ...
            <el-col :span="12" :offset="0">
              <el-form-item prop="teacherNum" label="编号">
                <el-input v-model="addModel.teacherNum"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
<script>
import { addApi, listApi,editApi,deleteApi,getRoleApi,getRoleByIdApi,resetPasswordApi } from "@/api/teacher.js";
